...
public class fractal_garden2 extends PApplet {
...
public int neighbors(int x, int y, char[][] world) {
...
class Turtle {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#DFDFDF", "fractal_garden2" });
  }
}
